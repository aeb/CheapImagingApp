...
<FancyMDSlider>
    ...
    MDCard:
        ...
        pos:
            ...
            slider.value_pos[1] - dp(8))
        MDLabel:
            text: slider.hint_box_text(slider.value)
            font_style: "Caption"
            halign: "center"
...
class FancyMDSlider(ThemableBehavior, Slider):
    ...
    hint_box_id = ObjectProperty(None)
